...
public class AppVenda {
    public static void main(String arg[]){
        try{
            ...
            /*Query query = em.createQuery("SELECT cliente FROM Cliente cliente WHERE cliente.nome = 'Benjamin'");
            Cliente cliente =(Cliente)query.getSingleResult();
            query = em.createQuery("SELECT vendedor FROM Vendedor vendedor WHERE vendedor.nome = 'Paulo'");
            ...
            query = em.createQuery("SELECT cliente FROM Cliente cliente WHERE cliente.nome = 'Jasmin'");
            cliente =(Cliente)query.getSingleResult();
            ...
            //relacao com cliente e vendedor
           /* Query query = em.createQuery("SELECT cliente FROM Cliente cliente WHERE cliente.nome = 'Benjamin'");
            Cliente cliente =(Cliente)query.getSingleResult();
            query = em.createQuery("SELECT vendedor FROM Vendedor vendedor WHERE vendedor.nome = 'Paulo'");
            Vendedor vendedor = (Vendedor)query.getSingleResult();
           ...
           Query query = em.createQuery("SELECT cliente FROM Cliente cliente WHERE cliente.nome = 'Bethouve'");
           Cliente cliente =(Cliente)query.getSingleResult();
            query = em.createQuery("SELECT vendedor FROM Vendedor vendedor WHERE vendedor.nome = 'Ana Maria'");
            Vendedor vendedor = (Vendedor)query.getSingleResult();
