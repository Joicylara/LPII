...
public class Excluir1 {
    public static void main(String args[]){
        ...
        //beneficio de pegar o objeto ao inves da chave primaria é ter a certeza do que estou pegando
        try{
            ...
            if(lista.size() > 0){
                grupoVO = lista.get(0);//pega o primeiro da lista para excluir
                em.remove(grupoVO);//deletando
